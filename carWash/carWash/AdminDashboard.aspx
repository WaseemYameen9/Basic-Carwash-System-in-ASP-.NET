<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="carWash.AdminDashboard" %>
...
<body>
    ...
    <form id="form1" runat="server">
    	...
    	<br />
		<asp:Button ID="GotoCarServices" runat="server" Text="Carwash Services" CssClass="btn btnn" OnClick="GotoCarServices_Click" />
		<br />
		<table class="auto-style22">
			<tr>
				<td class="auto-style16">Enter Carwash Name:</td>
				<td class="auto-style17">
					<input id="Nametxt" class="auto-style21" type="text" runat="server"/></td>
				<td class="auto-style18"></td>
			</tr>
			<tr>
				<td class="auto-style13">Enter Carwash Address:</td>
				<td class="auto-style14">
					<input id="Addresstxt" class="auto-style21" type="text" runat="server" /></td>
				<td class="auto-style15"></td>
			</tr>
			<tr>
				<td class="auto-style10">Enter Carwash City:</td>
				<td class="auto-style11">
					<input id="citytxt" class="auto-style20" type="text" runat="server"/></td>
				<td class="auto-style12"></td>
			</tr>
			<tr>
				<td class="auto-style10" id="errortxt" runat="server">You cannot delete carwash points unless you delete their services.</td>
				<td class="auto-style11">
					&nbsp;</td>
				<td class="auto-style12">&nbsp;</td>
			</tr>
